...
\begin{enumerate}
  ...
  \item \textbf{Generación:} Para cada tipo de instancia, se generan 5 archivos con datos aleatorios. El script permite fijar una semilla manualmente para reproducir instancias específicas, o usar una semilla aleatoria por defecto (\texttt{random.seed()}) para obtener variabilidad entre ejecuciones. Para esta entrega, se utilizó la semilla \texttt{42}, al igual que en ejecuciones anteriores, con el fin de mantener consistencia en las pruebas. El proceso incluye:
  \begin{itemize}
