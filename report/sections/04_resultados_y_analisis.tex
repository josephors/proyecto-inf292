...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../Entrega 2/analisis/graficos/objetivo_promedio_tipo.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../Entrega 2/analisis/graficos/objetivo_vs_tamano.png}
...
La siguiente figura muestra un ejemplo de calendario generado por el script \texttt{generar\_calendarios.py}, donde cada celda indica los turnos asignados a cada empleado durante la semana.
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../Entrega 2/analisis/graficos/calendarios/calendario_instancia_1.png}
...
respetan las restricciones R3 y R4: ningún trabajador realiza más de dos turnos diarios ni tiene secuencias noche–mañana.  
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../Entrega 2/analisis/graficos/tiempos_promedio_tipo.png}
...
También se puede ver, que incluso en el caso \textit{large}, el tiempo promedio se mantiene bajo (0.16 s), lo que confirma la eficiencia del modelo implementado.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../Entrega 2/analisis/graficos/tiempos_vs_variables.png}
