...
\begin{enumerate}
  ...
  \item \textbf{Generación:} Para cada tipo de instancia, se generan 5 archivos con datos aleatorios. Se utiliza una semilla aleatoria para permitir variabilidad entre ejecuciones y facilitar pruebas de factibilidad. El proceso incluye:
  \begin{itemize}
    ...
    \item Cálculo del límite máximo de turnos \( L_i = \left\lfloor \frac{2H}{3} \right\rfloor \) por trabajador, en cumplimiento de la restricción (R6) del modelo matemático.
