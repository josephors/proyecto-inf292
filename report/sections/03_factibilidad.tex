...
\begin{itemize}[leftmargin=1em]
    ...
    \item \textbf{Fines de semana (R5, parcialmente):} Se controla que la demanda agregada en sábados y domingos no exceda la capacidad global del equipo. La restricción completa sobre fines de semana consecutivos se delega al modelo.
