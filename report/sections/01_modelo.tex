...
\begin{itemize}
  ...
  % El parámetro de límite de carga L_i ha sido eliminado del modelo por decisión de diseño.
  % No se impone un límite global de turnos por trabajador en el modelo presentado.
...
\begin{itemize}
  ...
  \item[\textbf{(R6)}] \textbf{Naturaleza de las variables:} Se definen como binarias las variables de asignación y de actividad en fin de semana.
  \[
